...
import Image from "next/image"; // Assuming Next.js since you're using /portfolio/ path
                        ...
                        {p.image && (
                            <div className="absolute inset-0 z-0">
                                <Image 
                                    ...
                                    alt={p.title} 
                                    fill 
                                    className="object-cover transition-all duration-700 group-hover:scale-110 group-hover:blur-md group-hover:opacity-30"
                                />
                            </div>
                        )}
                        ...
                        <div className={`relative z-10 flex h-full flex-col justify-between p-10 transition-all duration-500 ${p.image ? "opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0" : "opacity-100"}`}>
                            ...
                            <div className="flex items-center justify-between border-t border-white/5 pt-6">
                                ...
                                <span className="text-sm font-semibold text-white flex items-center gap-2">
                                    View Case Study <span className="text-blue-500 group-hover:translate-x-1 transition-transform">→</span>
                                </span>
                            </div>
                        </div>
                    </article>
